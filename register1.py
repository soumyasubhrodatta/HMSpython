...
def Add():
    if fen.get()=="" or len.get()=="" or cont.get()=="" or courselist.get()=="" or email1.get()==""or pass1.get()=="" or pass2=="":
     ...
     print("connected")
     try:
        sql="insert into employee(fnm,lnm,contact,dob,course,gen,email,password,cpass)values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
...
courselist["values"]=("SELECT","office workers","cleaner","staff","security")
