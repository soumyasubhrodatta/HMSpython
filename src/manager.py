...
def Add():
    if fen.get()=="" or len.get()=="" or cont.get()=="" or courselist.get()=="" or email1.get()==""or pass1.get()=="" or pass2=="":
     ...
     print("connected")
     try:
        sql="insert into manager(fnm,lnm,contact,dob,course,gen,email,password,cpass)values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
...
reg=Label(frame,text="REGISTER HERE MANAGER",font=("Times New Roman",25,"bold"),fg="dark blue",bg="White")
reg.place(x=20,y=20)
...
courselist["values"]=("SELECT","Head manager","manager","registration manager","staff manager","clinic manager")
...
b1.place(x=30,y=410)
b5=Button(frame,text="Login",command=login_window,font=("Times New Roman",15,"bold"),fg="white",bg="blue")
b5.place(x=30,y=470)
