...
bg2=ImageTk.PhotoImage(file="10.jpg")
frame=Label(rt,image=bg2)
frame.place(x=30,y=40,width=1300,height=640)
...
b4=Button(frame,text="My Patients",command=docpat,font=("Times New Roman",15,"bold"),fg="white",bg="blue")
b4.place(x=50,y=120)
