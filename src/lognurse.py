...
bg1=ImageTk.PhotoImage(file="6.jpg")
logolb=Label(rt,image=bg1)
logolb.place(x=120,y=210,width=470,height=370)
...
reg1=Button(frame,command=log_win,cursor="hand2",text="Go back to Login Portal",font=("Times New Roman",15,"bold"),bg="dark blue",fg="white")
