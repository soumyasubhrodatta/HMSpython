...
bg2=ImageTk.PhotoImage(file="addbg.jpg")
frame=Label(rt,image=bg2)
frame.place(x=10,y=10,width=1500,height=1000)
...
unit1=Label(mangefrm,text="Validity",font=("Times New Roman",15,"bold"),bg="light blue")
...
btnfrm.place(x=10,y=400,width=420,height=60)
def add():
...
medtab.heading("units",text="Validity")
