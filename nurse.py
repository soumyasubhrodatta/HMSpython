...
def Add():
    if fen.get()=="" or len.get()=="" or cont.get()=="" or courselist.get()=="" or email1.get()==""or pass1.get()=="" or pass2=="":
     ...
     print("connected")
     try:
        sql="insert into nurse(fnm,lnm,contact,dob,course,gen,email,password,cpass)values(%s,%s,%s,%s,%s,%s,%s,%s,%s)"
...
reg=Label(frame,text="REGISTER HERE NURSE",font=("Times New Roman",25,"bold"),fg="dark blue",bg="White")
reg.place(x=20,y=20)
...
courselist["values"]=("SELECT","head nurse","OT nurse","junior nurse","nursemaid")
